#ifndef _GRAPHCLIQUE_H_
#define _GRAPHCLIQUE_H_

#include "../maximum_kplex/Utility.h"
#include "../maximum_kplex/LinearHeap.h"
...
public:
	...
	static int main_maximum_clique(char *file_path,int lower_bound,int binary_flag,double time_limit,char * type);
...
private:
	...
	ui degeneracy_maximal_clique_adj_list(const ui current_clique_size, ui *vs, const ui vs_size, char *vis, ui *degree,LinearHeap *heap) ;
